...
gapminder07 <- data.frame(gapminder[gapminder$year=='2007',])
gapminder07
...
(gapminder07[order(-gapminder07$pop),])[1:5,]
...
hist(gapminder07$lifeExp, main='lifeExp', xlab='lifeExp')

# Bonus: Change the `breaks = ` argument from its default setting and see what happens.
hist(gapminder07$lifeExp, breaks=30)
...
plot(gapminder07$gdpPercap,gapminder07$lifeExp, main='relationship')
